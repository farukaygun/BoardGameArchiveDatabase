...
(
	...
	aciklama TEXT,
	yayimciId INT FOREIGN KEY REFERENCES tblYayimci(id) ON DELETE CASCADE NOT NULL 
)
...
(
	...
	yorum TEXT,
	oyuncuId INT FOREIGN KEY REFERENCES tblOyuncu(id) ON DELETE NO ACTION,
	oyuncuIdKurar INT FOREIGN KEY REFERENCES tblOyuncu(id) ON DELETE NO ACTION,
	lokasyonId INT FOREIGN KEY REFERENCES tblLokasyon(id) ON DELETE NO ACTION
)
...
(
	...
	oyuncuId INT FOREIGN KEY REFERENCES tblOyuncu(id) ON DELETE CASCADE NOT NULL
)
...
(
	id INT PRIMARY KEY IDENTITY(1,1),
	adi NVARCHAR(30) NOT NULL,
	lokasyonId INT FOREIGN KEY REFERENCES tblLokasyon(id) ON DELETE CASCADE NOT NULL
)
...
(
	...
	oyunId INT FOREIGN KEY REFERENCES tblOyun(id) ON DELETE CASCADE NOT NULL
)
...
(
	artistId INT FOREIGN KEY REFERENCES tblArtist(id) ON DELETE CASCADE NOT NULL,
	oyunId INT FOREIGN KEY REFERENCES tblOyun(id) ON DELETE CASCADE NOT NULL
)

CREATE TABLE tblYayimciYayimlarOyun
(
	yayimciId INT FOREIGN KEY REFERENCES tblYayimci(id) ON DELETE CASCADE,
	oyunId INT FOREIGN KEY REFERENCES tblOyun(id) ON DELETE CASCADE NOT NULL
)

CREATE TABLE tblTasarimciTasarlarOyun
(
	tasarimciId INT FOREIGN KEY REFERENCES tblTasarimci(id) ON DELETE CASCADE,
	oyunId INT FOREIGN KEY REFERENCES tblOyun(id) ON DELETE CASCADE NOT NULL
)
...
(
	...
	oyunId INT FOREIGN KEY REFERENCES tblOyun(id) ON DELETE CASCADE NOT NULL,
	kategoriId INT FOREIGN KEY REFERENCES tblKategori(id) ON DELETE CASCADE NOT NULL
)
...
(
	OyuncuId INT FOREIGN KEY REFERENCES tblOyuncu(id) ON DELETE CASCADE NOT NULL,
	GrupId INT FOREIGN KEY REFERENCES tblGruplar(id) ON DELETE CASCADE NOT NULL
)
...
(
	ozellik NVARCHAR(20),
	OyuncuId INT FOREIGN KEY REFERENCES tblOyuncu(id) ON DELETE CASCADE NOT NULL,
	rozetId INT FOREIGN KEY REFERENCES tblRozet(id) ON DELETE CASCADE NOT NULL
)